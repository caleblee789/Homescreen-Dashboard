...
Scanned 25 production and active fixture files and classified 514 raw-color matches. Category 6 component hardcoding: **0**.

| Category | Classification | Matches |
|---:|---|---:|
| 1 | Core theme token | 355 |
...
- `settings.py:229` — `white` — Qt application-palette lookup; not a raw rendered color
- `settings.py:230` — `black` — Qt application-palette lookup; not a raw rendered color
