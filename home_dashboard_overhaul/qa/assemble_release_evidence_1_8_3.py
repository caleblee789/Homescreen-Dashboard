#!/usr/bin/env python3
"""Assemble immutable Home Dashboard 1.8.3 native release evidence.
...
DEFAULT_OUTPUT = SOURCE_ROOT / "qa" / "release-evidence-1.8.3-2026-08-23"
...
def main() -> int:
    ...
    planned = read_json(SOURCE_ROOT / "qa" / "capture_evidence_manifest_1_8_3.json")
