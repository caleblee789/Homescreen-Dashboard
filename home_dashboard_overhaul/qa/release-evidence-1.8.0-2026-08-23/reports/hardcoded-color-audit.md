...
Scanned 25 production and active fixture files and classified 295 raw-color matches. Category 6 component hardcoding: **0**.

| Category | Classification | Matches |
|---:|---|---:|
| 1 | Core theme token | 167 |
| 2 | Stable semantic token | 32 |
| 3 | Data visualization token | 69 |
...
- `config.json:60` — `#1E90FF` — persisted user-configurable custom verse-color default
