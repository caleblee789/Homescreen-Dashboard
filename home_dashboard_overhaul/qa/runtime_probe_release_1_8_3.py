"""Fail-closed native Deck Browser evidence probe for release 1.8.3.
...
OUTPUT_ROOT = RUN_ROOT / "hdo-release-evidence-1.8.3"
...
ENABLED = (
    ...
    and EXPECTED_PROFILE.startswith("Codex QA HDO 1.8.3 ")
...
def _candidate_install_identity() -> dict[str, Any]:
    ...
    _require(manifest.get("human_version") == RELEASE, "installed manifest version is not 1.8.3")
    return {
