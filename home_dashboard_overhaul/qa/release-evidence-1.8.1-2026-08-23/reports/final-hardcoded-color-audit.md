...
Scanned 25 production and active fixture files and classified 287 raw-color matches. Category 6 component hardcoding: **0**.

| Category | Classification | Matches |
|---:|---|---:|
| 1 | Core theme token | 167 |
| 2 | Stable semantic token | 32 |
| 3 | Data visualization token | 61 |
| 4 | Shadow or overlay | 8 |
...
- `config.json:59` — `#1E90FF` — persisted user-configurable custom verse-color default
...
- `settings.py:252` — `white` — Qt application-palette lookup; not a raw rendered color
- `settings.py:253` — `black` — Qt application-palette lookup; not a raw rendered color
